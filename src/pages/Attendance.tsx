...
const Attendance = () => {
  ...
  const [filters, setFilters] = useState({ name: "", dateRange: null as any });
  ...
  const fetchLogs = async () => {
    ...
    try {
      ...
      setLogs(data.filter((log: any) => log.userId.role === "Staff")); // Only Staff
    } catch (error) {
  ...
  return (
    <>
      <Card
        ...
        title={
          <Space>
            <FilterOutlined style={{ color: "#1677ff", cursor: "pointer" }} onClick={() => setDrawerVisible(true)} />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            >
              ...
              <Descriptions.Item label="Role">
                <Tag color="#DC143C">{selectedUser.userId.role}</Tag>
              </Descriptions.Item>
